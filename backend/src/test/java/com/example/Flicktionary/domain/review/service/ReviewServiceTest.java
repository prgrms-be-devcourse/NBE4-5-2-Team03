...
public class ReviewServiceTest {
    ...
    void printReview() {
        ...
        // 리뷰 생성 및 변수에 저장
        ReviewDto reviewDto = reviewService.createReview(reviewDto1, 12L);
    ...
    void printReviewFailNull() {
        ...
        Throwable thrownOnEmpty = catchThrowable(() -> reviewService.createReview(reviewEmpty, 12L));
        Throwable thrownOnNull = catchThrowable(() -> reviewService.createReview(reviewNull, 12L));
    ...
    void printReviewFailRating() {
        ...
        Throwable thrown = catchThrowable(() -> reviewService.createReview(reviewNoRating, 12L));
    ...
    void createReviewUpdateMovie() {
        ...
        // 리뷰 생성 및 변수에 저장
        ReviewDto review = reviewService.createReview(reviewDto1, 12L);
    ...
    void createReviewUpdateSeries() {
        ...
        // 리뷰 생성 및 변수에 저장
        ReviewDto review = reviewService.createReview(reviewDto2, 12L);
    ...
    void updateReview() {
        ...
        // 수정
        ReviewDto result = reviewService.updateReview(reviewDto1.getId(), updatedReviewDto, 12L);
    ...
    void updateReviewUpdateMovie() {
        ...
        // 수정
        ReviewDto review = reviewService.updateReview(reviewDto1.getId(), updatedReviewDto, 12L);
    ...
    void updateReviewUpdateSeries() {
        ...
        // 수정
        ReviewDto review = reviewService.updateReview(reviewDto2.getId(), updatedReviewDto, 12L);
    ...
    void updateNonexistentReview() {
        ...
        // 수정
        Throwable thrown = catchThrowable(() -> reviewService.updateReview(1234L, reviewDto1, 12L));
    ...
    void deleteReview() {
        ...
        // 리뷰 삭제
        reviewService.deleteReview(reviewDto1.getId(), 12L);
    ...
    // 리뷰 삭제
    reviewService.deleteReview(reviewDto2.getId(), 12L);
    ...
    void deleteNonexistentReview() {
        ...
        // 리뷰 삭제
        Throwable thrown = catchThrowable(() -> reviewService.deleteReview(reviewDto1.getId(), 12L));
